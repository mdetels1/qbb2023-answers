...
x = [10, 11, 12, 13, "14A", "14B", "14C", "14D"] #can also use strip to strip the female and male titles I believe
...
ax.set_title( "SisA" )
plt.tight_layout()
line1, = ax.plot( x, yf, label = "Female Data")
line2, = ax.plot( x, ym, label = "Male Data")
line3, = ax.plot( x, ym2, label = "2X Male Data")
ax.legend(handles = [line1, line2, line3])
fig.savefig( "FBtr0073461.pdf")
plt.close( fig )